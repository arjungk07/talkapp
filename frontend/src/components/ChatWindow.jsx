...
const ChatWindow = ({ className }) => {
  ...
  return (
    ...
    >
      ...
      {/* ── FOOTER — never shrinks; keyboard pushes it up via 100dvh ── */}
      <footer
            ...
            <>
              ...
              <div className="flex w-full relative">
                <input
                  ...
                  maxLength={2000}
                  className="w-full bg-transparent border-0 focus:ring-0 focus:outline-none px-4 text-chat-text placeholder-chat-muted text-sm"
                />
                {text.length > 1800 && (
                  <span className="absolute right-14 top-1/2 -translate-y-1/2 text-xs text-chat-muted">
                    {2000 - text.length}
                  </span>
                )}
